...
int do_copy(object target,int mode)
{
	...
	if(mode) {
		...
		me->set("str", (int)ob->query("str")*120/100);
		me->set("int", (int)ob->query("str")*120/100);
		me->set("con", (int)ob->query("str")*120/100);
		me->set("dex", (int)ob->query("str")*120/100);
		lv = ob->query("max_pot") -100;
		lv = lv * 16/10;
		exp = ob->query("combat_exp") *16/10;
		//exp = exp * (100+random(20))/100;
		me->set("no_party_job",1);
		me->set("max_qi", (int)ob->query("max_qi")*40/10*t/10 );
		me->set("eff_qi", (int)ob->query("max_qi")*40/10*t/10 );
		me->set("qi", (int)ob->query("max_qi")*40/10*t/10 );
		me->set("max_jing",(int)ob->query("max_jing")*10/10*t/10);
		me->set("eff_jing",(int)ob->query("max_jing")*10/10*t/10);
		me->set("jing",(int)ob->query("max_jing")*10/10*t/10);
	...
	{
		t = 12;
		me->set("str", (int)ob->query("str")*10/10*t/10);
		me->set("int", (int)ob->query("int")*10/10*t/10);
		me->set("con", (int)ob->query("con")*10/10*t/10);
		me->set("dex", (int)ob->query("dex")*10/10*t/10);
		lv = ob->query("max_pot") -100;
		lv = lv * t/10;
		exp = ob->query("combat_exp") *t/10;
		exp = exp * (100+random(20))/100;
		me->set("no_party_job",1);
		me->set("max_qi", (int)ob->query("max_qi")*20/10*t/10 );
		me->set("eff_qi", (int)ob->query("max_qi")*20/10*t/10 );
		me->set("qi", (int)ob->query("max_qi")*20/10*t/10 );
		me->set("max_jing",(int)ob->query("max_jing")*10/10*t/10);
		me->set("eff_jing",(int)ob->query("max_jing")*10/10*t/10);
		me->set("jing",(int)ob->query("max_jing")*10/10*t/10);
		me->set("max_neili",(int)ob->query("max_neili"));
	...
	if ((int)me->query_skill("force")/4<=200)

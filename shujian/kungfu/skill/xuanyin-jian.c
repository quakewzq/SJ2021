...
{
	int i, j, level,power1,power2;
	power1	= (int) me->query_skill("sword",1);
	power2	= (int) me->query_skill("force",1);
	...
	for(i = sizeof(action); i > 0; i--)
			...
			return ([
                ...
                "damage":       250 + to_int(power1/5) + random(180),
				"force":	300 + to_int(power2/5) + random(350),
				"dodge":	random(30),
				"parry":	random(30),
			]);
		}

...
string s_power(int i)
{
	...
	if( i >= 1200 )	return HIC"逆转乾坤"NOR;
	if( i >= 1100 )	return HIW"颠倒阴阳"NOR;
	if( i >= 1000 )	return HIW"震天撼地"NOR;
	if( i >= 900 )	return HIY"雷霆万钧"NOR;
	if( i >= 800 )	return HIY"天翻地覆"NOR;
	if( i >= 700 )	return HIY"石破天惊"NOR;
	if( i >= 600 )	return HIR"摧枯拉朽"NOR;
	if( i >= 500 )	return HIR"大巧不工"NOR;
	if( i >= 400 )	return HIM"绝世神兵"NOR;
	if( i >= 300 )	return HIM"毁天灭地"NOR;

...
mixed hit_ob(object me, object target, int damage_bonus)   //主动攻击特效.自娱自乐的东西不知道能行不？
{
switch (random(5))
                {
				case 0:
	                    message_vision(HIB"$N猛然领悟「太玄经」掌法之精髓"HBRED+HIW"“纵死·侠骨香”"NOR+WHT"，$n的招数悉数被你一一拆解。\n"NOR,me,target);
     	   	            target->set_temp("lost_attack",1);
				        break;
				case 1:
                        message_vision(HIB"$N上前一步，双臂打开，正所谓之"HBRED+HIG"五岳·倒为轻"NOR+WHT",$n哪里见过如此精妙武功，顿时呆若木鸡！\n"NOR,me,target);
				...
				case 2:	
                     ...
                     break; 				
				case 3:	
                          message_vision(WHT"$N默念「太玄经」心诀，"HBMAG+HIW"意气素霓生，喧赫大梁城"NOR+WHT"，顿时化解$n了攻击。\n"NOR,me,target); 
